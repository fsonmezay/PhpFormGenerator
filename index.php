...
<body>
  <div class="container">
    ...
    */
    ...
    $fileFieldForm->addFile("File Disabled", "file-disabled", "", true);
    ...
    $textareaForm->addTextarea("Textarea disabled", "textarea-disabled", "", "", "", true);
    ...
    $selectFieldForm->addSelect("Select Disabled", "select-disabled", $cities, array(2), "", true);
    ...
    $radioForm->addRadio("Radio disabled", "radio-disabled", $cities, 2, "", true);
